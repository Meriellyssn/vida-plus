/**
 * Página de Login - Sistema Vida Plus
 *
 * Este componente representa a tela de autenticação do sistema,
 * oferecendo campos para entrada de e-mail e senha, além de feedback
 * visual durante o processo de login.
 *
 * Funcionalidades principais:
 * - Validação simples de email e senha com base em usuários simulados.
 * - Armazenamento de informações do usuário no localStorage.
 * - Redirecionamento condicional para dashboards específicos
 *   (paciente, profissional ou admin).
 * - Interface estilizada com Tailwind CSS e feedback visual de carregamento.
 *
...
// Usuários simulados para testes (mock de autenticação)
const mockUsers = {
  ...
  'medico@vidaplus.com': {
    ...
    avatarUrl: 'https://i.postimg.cc/rsj9f97v/16.png',
  },
  'admin@vidaplus.com': {
    tipo: 'admin',
    nome: 'Dr. João Admin',
...
export function LoginPage() {
  // Estados para capturar entrada do usuário e status do login
  ...
  /**
   * Função que executa a validação e o processo de login.
  ...
  return (
    <div className="min-h-screen flex items-center justify-center p-4 bg-gradient-to-br from-primary to-secondary">
      ...
      <div className="bg-white rounded-2xl shadow-2xl overflow-hidden max-w-4xl w-full grid lg:grid-cols-2 relative">
        {/* --- Lado esquerdo (informações e logotipo) --- */}
        <div className="p-8 text-white bg-gradient-to-br from-primary to-secondary hidden lg:flex flex-col items-center justify-center text-center">
          <img src={logoVidaPlus} alt="Logo VidaPlus" className="w-40 mb-6" />
          ...
          <ul className="space-y-3 text-left max-w-xs">
            <li className="flex items-center">
              <i className="fas fa-check mr-3"></i>Gestão completa de pacientes
            </li>
            <li className="flex items-center">
              <i className="fas fa-check mr-3"></i>Agendamento inteligente
            </li>
            <li className="flex items-center">
              <i className="fas fa-check mr-3"></i>Prontuários digitais
            </li>
            <li className="flex items-center">
              <i className="fas fa-check mr-3"></i>Telemedicina integrada
            </li>
          </ul>
        </div>
        ...
        <div className="p-8 md:p-12">
          ...
          <form onSubmit={handleLogin} noValidate>
            ...
            <button
              ...
              disabled={isLoading}
            >
              {/* Loader animado quando está carregando */}
              {isLoading && (
            ...
            <div className="bg-gray-50 border border-gray-200 rounded-lg p-4 mt-6">
              ...
              <div className="space-y-2 text-sm text-gray-600">
                <div>
                  <strong>Admin:</strong> admin@vidaplus.com | 123456
                </div>
                <div>
                  <strong>Médico:</strong> medico@vidaplus.com | 123456
                </div>
                <div>
                  <strong>Paciente:</strong> paciente@vidaplus.com | 123456
                </div>
              </div>
            </div>
          </form>
        ...
        {/* Rodapé de identificação acadêmica */}
